...
l("Array.prototype.findIndex",function(a){return a?a:function(a,c){a:{var b=this;b instanceof String&&(b=String(b));for(var g=b.length,k=0;k<g;k++)if(a.call(c,b[k],k,b)){a=k;break a}a=-1}return a}});var m="function"==typeof Object.assign?Object.assign:function(a,b){for(var c=1;c<arguments.length;c++){var d=arguments[c];if(d)for(var g in d)Object.prototype.hasOwnProperty.call(d,g)&&(a[g]=d[g])}return a};l("Object.assign",function(a){return a||m});function n(a,b){var c=this;this.a={};this.options=b;this.g=[];this.data=this.a.data;this.j=a;this.c="";this.b=-1;this.i=!1;p(this.j);this.h=document.createElement("input");this.h.setAttribute("class","ac-input");this.h.setAttribute("placeHolder",this.a.placeHolder);this.j.appendChild(this.h);[["input",this.l],["click",this.u],["keydown",this.v],["blur",this.s]].map(function(a){return c.h.addEventListener(a[0],a[1].bind(c))});this.f=document.createElement("div");this.f.style.maxHeight=this.a.maxHeight+
"px";this.f.setAttribute("class","ac-items");this.j.appendChild(this.f);this.f.addEventListener("mousedown",this.w.bind(this))}e=n.prototype;e.l=function(){this.c=this.h.value.toLowerCase();this.close();!1===this.a.open&&(this.c.length<this.a.minChars||this.f.childElementCount)||q(this).map(this.m,this)};
...
this.a.labelField=this.a.searchField=this.a.dataField="text"):this.g=a;this.a.searchField!=this.a.labelField&&(this.a.highlight=!1)},get:function(){return this.g}},options:{configurable:!0,enumerable:!0,set:function(a){Object.assign(this.a,{placeHolder:"",open:!1,highlight:!0,maxHeight:500,minChars:3,labelField:"",searchField:"",dataField:"",data:[],onSelect:function(){}},a)}}});var r=["AutoComplete"],t=this;r[0]in t||"undefined"==typeof t.execScript||t.execScript("var "+r[0]);
