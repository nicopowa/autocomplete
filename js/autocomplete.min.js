...
function r(a,b){var c=b.toLowerCase().indexOf(a.f);return b.slice(0,c)+'<font color="#FF9400">'+b.slice(c,c+a.f.length)+"</font>"+b.slice(c+a.f.length,b.length)}e.o=function(a){a=this.h[a.target.getAttribute("data-value")];this.c.value=a[this.a.labelField];this.f=this.c.value.toLowerCase();this.a.onSelect(a[this.a.dataField],a);this.i=!1;this.close()};e.u=function(){this.close();!0===this.a.open&&""==this.f?this.h.map(this.m,this):this.l(null)};
